...
# Set up logger
log = logging.getLogger("flask-admin.humbledb")
...
class ModelView(BaseModelView):
    ...
    def __init__(self, con_ctx, coll,
        ...
        if endpoint is None:
            endpoint = ('%sview' % coll.config_collection).lower()

        self.con_ctx = con_ctx
        self.coll = coll
    ...
    def scaffold_form(self):
        # raise NotImplementedError()
        # return self.form_base_class
        form_class = get_form(self.coll,
    ...
    def _search(self, query, search_term):
        ...
        for value in values:
            ...
            for field in self._search_fields:
                # field = getattr(self.coll, field, field)
    ...
    def _get_list_value(self, context, model, name, column_formatters,
        ...
        '''map field name to short name.
        '''
        # name = getattr(self.coll, name, name)
        return super()._get_list_value(
            context, model, name, column_formatters, column_type_formatters,
        )
    ...
    def get_list(self, page, sort_column, sort_desc, search, filters,
        ...
        if sort_column:
            # sort_column = getattr(self.coll, sort_column, sort_column)
